...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen bg-primary-dark/80 overflow-hidden">
      ...
      {/* 2. FIXED PARALLAX BACKGROUND LAYER */}
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none"></div>
      <motion.div 
        style={{ y: yBg }}
        className="fixed -top-[10%] left-0 w-full h-[120%] md:h-[120%]"
      >
        <img 
          src="./assets/upc.jpg" 
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-primary-dark/40 via-primary-dark/60 to-primary-dark"></div>
      </motion.div>
      ...
      {/* 8. CHAT WIDGET (Placed Correctly at Bottom) */}
      <HomeChatWidget />
